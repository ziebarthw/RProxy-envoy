...
RpRawBufferSocketFactory* rp_raw_buffer_socket_factory_create_upstream_factory(const upstream_cfg_t* upstream_cfg);
RpRawBufferSocketFactory* rp_raw_buffer_socket_factory_create_downstream_factory(const server_cfg_t* server_cfg);
