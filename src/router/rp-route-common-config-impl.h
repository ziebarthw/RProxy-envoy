...
typedef SHARED_PTR(RpRouteCommonConfig) RpRouteCommonConfigSharedPtr;

RpRouteCommonConfig* rp_route_common_config_impl_create(RpRouteConfiguration* config,
                                                            RpServerFactoryContext* factory_context);
const char* rp_route_common_config_impl_name(RpRouteCommonConfigSharedPtr self);
guint32 rp_route_common_config_impl_max_direct_response_body_size_bytes(RpRouteCommonConfigSharedPtr self);
