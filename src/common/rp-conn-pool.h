 ...
 */
typedef void (*idle_cb)(RpConnectionPoolInstance*);

struct _RpConnectionPoolInstanceInterface {
    GTypeInterface parent_iface;

    void (*add_idle_callback)(RpConnectionPoolInstance*, idle_cb);
...
static inline void
rp_connection_pool_instance_add_idle_callback(RpConnectionPoolInstance* self, idle_cb cb)
{
